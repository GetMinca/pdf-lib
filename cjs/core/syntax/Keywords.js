...
var Space = CharCodes_1.default.Space, CarriageReturn = CharCodes_1.default.CarriageReturn, Newline = CharCodes_1.default.Newline, Tab = CharCodes_1.default.Tab, LessThan = CharCodes_1.default.LessThan, GreaterThan = CharCodes_1.default.GreaterThan, BackSlash = CharCodes_1.default.BackSlash;
var stream = [
...
exports.Keywords = {
    ...
    embeddedStream1: tslib_1.__spreadArrays([Tab], stream),
    embeddedStream2: tslib_1.__spreadArrays([Space], stream),
    embeddedStream3: tslib_1.__spreadArrays([CarriageReturn], stream),
    embeddedStream4: tslib_1.__spreadArrays([Newline], stream),
    embeddedStream5: tslib_1.__spreadArrays([LessThan], stream),
    embeddedStream6: tslib_1.__spreadArrays([GreaterThan], stream),
    embeddedStream7: tslib_1.__spreadArrays([BackSlash], stream),
    endstream: endstream,
