...
var PDFObjectParser = /** @class */ (function (_super) {
    ...
    PDFObjectParser.prototype.findEndOfStreamFallback = function (startPos) {
        ...
        var acceptUnprefixedStream = true;
        var nestingLvl = 1;
        var end = this.bytes.offset();
        while (!this.bytes.done()) {
            end = this.bytes.offset();
            if (this.matchKeyword(Keywords_1.Keywords.embeddedStream1) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream2) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream3) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream4) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream5) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream6) ||
                this.matchKeyword(Keywords_1.Keywords.embeddedStream7) ||
                (acceptUnprefixedStream && this.matchKeyword(Keywords_1.Keywords.stream))) {
                nestingLvl += 1;
